...
namespace FileRenamer.WindowsAPI.PInvoke.User32
{
    ...
    public enum WindowStyle : uint
    {
        ...
        /// <summary>
        /// 窗口具有最大化按钮。 不能与 <see cref="WindowStyleEx.WS_EX_CONTEXTHELP"> 样式组合。 还必须指定 <see cref="WS_SYSMENU"> 样式。
        /// </summary>
        ...
        /// <summary>
        /// 窗口具有最小化按钮。 不能与 <see cref="WindowStyleEx.WS_EX_CONTEXTHELP"> 样式组合。 还必须指定 <see cref="WS_SYSMENU"> 样式。
        /// </summary>
