using PowerToolboxShellExtension.Extensions.DataType.Constant;
using PowerToolboxShellExtension.Services.Root;

namespace PowerToolboxShellExtension.Services.Controls.Settings
{
    /// <summary>
    /// 文件右键菜单设置服务
    /// </summary>
