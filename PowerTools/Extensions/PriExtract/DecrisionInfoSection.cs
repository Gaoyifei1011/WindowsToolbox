...
namespace PowerTools.Extensions.PriExtract
{
    public sealed class DecrisionInfoSection
    {
        ...
        public DecrisionInfoSection(string sectionIdentifier, BinaryReader binaryReader)
        {
            ...
            for (int index = 0; index < numDecisions; index++)
            {
            ...
            for (int index = 0; index < numQualifierSets; index++)
            {
            ...
            {
                ushort subIndex = binaryReader.ReadUInt16();
            ...
            for (int index = 0; index < numQualifiers; index++)
            {
                DistinctQualifierInfo distinctQualifierInfo = distinctQualifierInfosList[qualifierInfosList[index].Index];
                ...
                qualifiersList.Add(new Qualifier()
                {
                    ...
                    Priority = qualifierInfosList[index].Priority,
                    FallbackScore = qualifierInfosList[index].FallbackScore / 1000f,
                    Value = value
                });
            }
