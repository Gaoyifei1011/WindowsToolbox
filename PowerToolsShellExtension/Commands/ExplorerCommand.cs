...
using PowerToolsShellExtension.Services.Controls.Settings;
...
using PowerToolsShellExtension.WindowsAPI.PInvoke.Shlwapi;
using System;
...
namespace PowerToolsShellExtension.Commands
{
    /// <summary>
    /// 菜单项
    /// </summary>
