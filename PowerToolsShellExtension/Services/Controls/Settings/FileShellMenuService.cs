using PowerToolsShellExtension.Extensions.DataType.Constant;
using PowerToolsShellExtension.Services.Root;

namespace PowerToolsShellExtension.Services.Controls.Settings
{
    /// <summary>
    /// 文件右键菜单设置服务
    /// </summary>
