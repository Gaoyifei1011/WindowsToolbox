...
namespace WindowsTools.WindowsAPI.PInvoke.Comctl32
{
    ...
    public static partial class Comctl32Library
    {
        ...
        [DllImport(Comctl32, CharSet = CharSet.Unicode, EntryPoint = "SetWindowSubclass", SetLastError = false), PreserveSig]
        ...
        [DllImport(Comctl32, CharSet = CharSet.Unicode, EntryPoint = "DefSubclassProc", SetLastError = false), PreserveSig]
        ...
        [DllImport(Comctl32, CharSet = CharSet.Unicode, EntryPoint = "RemoveWindowSubclass", SetLastError = false), PreserveSig]
        [return: MarshalAs(UnmanagedType.Bool)]
