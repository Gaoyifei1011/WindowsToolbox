...
namespace WindowsTools.WindowsAPI.PInvoke.Comctl32
{
    ...
    public static partial class Comctl32Library
    {
        ...
        [DllImport(Comctl32, CharSet = CharSet.Unicode, EntryPoint = "SetWindowSubclass", SetLastError = false, PreserveSig = true)]
        ...
        [DllImport(Comctl32, CharSet = CharSet.Unicode, EntryPoint = "DefSubclassProc", SetLastError = false, PreserveSig = true)]
        ...
        [DllImport(Comctl32, CharSet = CharSet.Unicode, EntryPoint = "RemoveWindowSubclass", SetLastError = false, PreserveSig = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
