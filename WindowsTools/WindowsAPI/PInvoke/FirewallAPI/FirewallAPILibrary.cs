...
namespace WindowsTools.WindowsAPI.PInvoke.FirewallAPI
{
    public static class FirewallAPILibrary
    {
        ...
        [DllImport(FirewallAPI, CharSet = CharSet.Unicode, EntryPoint = "NetworkIsolationEnumAppContainers", SetLastError = false), PreserveSig]
        ...
        [DllImport(FirewallAPI, CharSet = CharSet.Unicode, EntryPoint = "NetworkIsolationGetAppContainerConfig", SetLastError = false), PreserveSig]
