...
namespace WindowsTools.WindowsAPI.PInvoke.Kernel32
{
    ...
    public static class Kernel32Library
    {
        ...
        [DllImport(Kernel32, CharSet = CharSet.Unicode, EntryPoint = "GetCurrentApplicationUserModelId", SetLastError = false)]
        ...
        [DllImport(Kernel32, CharSet = CharSet.Unicode, EntryPoint = "GetCurrentPackageFullName", SetLastError = false)]
        ...
        [DllImport(Kernel32, CharSet = CharSet.Unicode, EntryPoint = "SetThreadExecutionState", SetLastError = false)]
