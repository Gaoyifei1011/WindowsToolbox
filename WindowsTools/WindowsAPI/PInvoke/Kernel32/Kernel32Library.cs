...
namespace WindowsTools.WindowsAPI.PInvoke.Kernel32
{
    ...
    public static class Kernel32Library
    {
        ...
        [DllImport(Kernel32, CharSet = CharSet.Unicode, EntryPoint = "GetCurrentApplicationUserModelId", SetLastError = false, PreserveSig = true)]
        ...
        [DllImport(Kernel32, CharSet = CharSet.Unicode, EntryPoint = "GetCurrentPackageFamilyName", SetLastError = false, PreserveSig = true)]
        ...
        [DllImport(Kernel32, CharSet = CharSet.Unicode, EntryPoint = "GetSystemPowerStatus", SetLastError = false, PreserveSig = true)]
        ...
        [DllImport(Kernel32, CharSet = CharSet.Unicode, EntryPoint = "SetThreadExecutionState", SetLastError = false, PreserveSig = true)]
