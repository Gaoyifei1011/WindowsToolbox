...
namespace WindowsTools.WindowsAPI.PInvoke.Ole32
{
    ...
    public static class Ole32Library
    {
        ...
        internal static extern int CoCreateInstance(ref Guid rclsid, [MarshalAs(UnmanagedType.IUnknown)] object pUnkOuter, CLSCTX dwClsContext, ref Guid riid, [MarshalAs(UnmanagedType.IUnknown)] out object ppv);
        ...
        [DllImport(Ole32, CharSet = CharSet.Unicode, EntryPoint = "CoSetProxyBlanket", SetLastError = true)]
        internal static extern int CoSetProxyBlanket([In] IntPtr punk, [In] uint dwAuthnSvc, [In] uint dwAuthzSvc, [In] IntPtr pServerPrincName, [In] uint dwAuthLevel, [In] uint dwImpLevel, [In] IntPtr pAuthInfo, [In] uint dwCapabilities);
    }
}
