...
namespace WindowsToolsShellExtension.WindowsAPI.ComTypes
{
    ...
    public partial interface IEnumExplorerCommand
    {
        ...
        [PreserveSig]
        int Next(uint celt, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.Interface, SizeParamIndex = 0)] IExplorerCommand[] pUICommand, out uint pceltFetched);
